...
describe('validate', () => {
    describe('checkLength', () => {
        it('Should return true for strings between 3 and 20 characters long', () => {
            const user = 'shortstring';

            expect(checkLength(user)).toBe(true);
        });

        it('Should return an error message if longer than 20 characters', () => {
            const user = 'iamareallylongstringandshouldnotpass';

            expect(checkLength(user)).toBe('This field must be between 3 and 20 characters long.');
        });

        it('Should return error message if nothing is entered', () => {
            const user = '';
    ...
    describe('checkValue', () => {
        ...
        it('Should return error message if no value is entered', () => {
            const input = '';
    ...
    describe('checkNumber', () => {
        ...
        it('Should return error message if the value entered is 0', () => {
            const num = 0;

            expect(checkNumber(num)).toBe('This value must be a valid number with a minimum value of 1.');
        });

        it('Should return error message if the value entered is negative', () => {
            const num = -3;

            expect(checkNumber(num)).toBe('This value must be a valid number with a minimum value of 1.');
        });

        it('Should return error message if the value entered is not a number', () => {
            const num = 'string';
